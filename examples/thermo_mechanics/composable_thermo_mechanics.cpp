...
int main(int argc, char* argv[])
{
  ...
  auto solid_system = smith::buildSolidMechanicsSystem<dim, order>(
      solid_solver, smith::SolidMechanicsOptions{}, solid_fields, smith::couplingFields(thermal_fields));
  auto thermal_system = smith::buildThermalSystem<dim, order>(
      thermal_solver, smith::ThermalOptions{}, thermal_fields, smith::couplingFields(solid_fields));
