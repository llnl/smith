...
if(MFEM_FOUND)
    ...
    foreach(_include_flag ${mfem_tpl_inc_flags})
        ...
        if(_pos EQUAL 0)
            ...
            string(REPLACE "${CMAKE_SOURCE_DIR}/smith_tpls" "/Users/mrtupek/smith_tpls" _include_dir "${_include_dir}")
    ...
    if(NOT mfem_tpl_lnk_flags EQUAL "")
        ...
        string(REPLACE "${CMAKE_SOURCE_DIR}/smith_tpls" "/Users/mrtupek/smith_tpls" mfem_tpl_lnk_flags "${mfem_tpl_lnk_flags}")
    else()
