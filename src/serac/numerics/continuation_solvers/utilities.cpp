...
HypreParMatrix* GenerateHypreParMatrixFromSparseMatrix(HYPRE_BigInt* colOffsetsloc, HYPRE_BigInt* rowOffsetsloc,
                                                       SparseMatrix* Asparse)
{
  ...
  Ahypre =
      new HypreParMatrix(MPI_COMM_WORLD, nrows_loc, nrows_glb, ncols_glb, AI, AJ, Adata, rowOffsetsloc, colOffsetsloc);
  return Ahypre;
}

HypreParMatrix* GenerateHypreParMatrixFromDiagonal(HYPRE_BigInt* offsetsloc, Vector& diag)
{
