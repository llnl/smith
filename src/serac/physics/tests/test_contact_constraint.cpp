...
#include "serac/physics/contact_constraint.hpp"
...
struct ContactConstraintFixture : public testing::Test {
  ...
  void SetUp()
  {
    ...
    serac::StateManager::initialize(datastore, "contact_constraint");

    mesh = std::make_shared<serac::Mesh>(shared::MeshBuilder::Unify({shared::MeshBuilder::CubeMesh(1, 1, 1)
                                                                         .updateBdrAttrib(3, 7)
                                                                         .updateBdrAttrib(1, 3)
                                                                         .updateBdrAttrib(4, 7)
                                                                         .updateBdrAttrib(5, 1)
    ...
    serac::ContactOptions contact_opts{.method = serac::ContactMethod::SingleMortar,
    ...
    constraint = std::make_unique<serac::ContactConstraint>(interaction_id, mesh->mfemParMesh(), bdry_attr_surf1,
  ...
  std::unique_ptr<serac::Constraint> constraint;
