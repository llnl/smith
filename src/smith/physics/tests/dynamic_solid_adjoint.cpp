...
{
  auto solid_solver = createNonlinearSolidMechanicsSolver();
  auto [qoi1, shape_unused1, shape_unused2, shape_sensitivity1] = computeSolidMechanicsQoiSensitivities(*solid_solver, tsInfo);
  ...
  auto [qoi2, shape_unused3, shape_unused4, shape_sensitivity2] = computeSolidMechanicsQoiSensitivities(*solid_solver, tsInfo);
