...
class ContactInteraction {
 public:
   ...
   * @param current_coords Reference to the grid function holding current mesh coordinates
 ...
 private:
  /**
   * @brief Get the Tribol enforcement method given a Smith enforcement method
   *
