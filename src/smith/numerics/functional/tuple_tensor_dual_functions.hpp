...
/**
 * @brief a tuple type with n entries, all of which are of type `smith::zero`,
...
/**
 * @tparam i the index where the non-`smith::zero` derivative term appears
 ...
 *
 * @tparam T either `double` or a `smith::dual` type
