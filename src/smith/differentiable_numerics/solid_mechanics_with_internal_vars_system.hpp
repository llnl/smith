 ...
 * @brief Helper to wire an internal-variable material to composed solid and state systems.
 */
 ...
 *        a StateVariableSystem carrying internal variables.
 *
 * Assumes:
    ...
    const std::string& domain_name)
{
  ...
  auto captured_state_rule = state->state_time_rule;
