...
std::unordered_map<std::string, std::string> defineAndParse(int argc, char* argv[], std::string app_description)
{
  ...
  //   smith::cli::printGiven() (in this file)
  ...
  if (version) {
    ...
    if (output_directory == "") {
      ...
      output_directory = smith::input::getInputFileName(input_file_path);
    }
