...
class Axom(CachedCMakePackage, CudaPackage, ROCmPackage):
    ...
    # SERAC EDIT START
    # Builds with C++17
    version("0.11.0.1_lido", commit="aadf1a9955fe85d106218e38aaa44b4b63b14a73", submodules=False)
    ...
    # SERAC EDIT START
    patch("lua_reader_nvcc.patch", when="@0.11.0.1")
    # SERAC EDIT END
    ...
    # SERAC EDIT START
    variant("cpp17", default=True, description="Build with C++17 support")
    # SERAC EDIT END
    ...
    def initconfig_compiler_entries(self):
        ...
        # SERAC EDIT START
        if spec.satisfies("+cpp17") and spec.satisfies("@:0.6.1"):
