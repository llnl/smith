...
# NOTE: Axom's Spack package in the Spack packages repo isn't as up to date as in Axom itself. Specifically, we needed this change:
# https://github.com/LLNL/axom/blob/515b9bdec47886d19505533ccbdb1c37177d05f2/scripts/spack/packages/axom/package.py#L368
# TODO: revert to inherited package once this change is in the Spack package repo
